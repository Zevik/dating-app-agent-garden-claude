...
## RTL (מימין לשמאל)
- כל הממשק ברירת מחדל RTL
- `dir="rtl"` ו-`lang="he"` ב-`<html>`
- Tailwind עם `tailwindcss-rtl`
- טקסטים, כפתורים, שדותקלט מיושרים לימין
- בועות צ'אט: הודעות המשתמש מימין, הצד השני משמאל
- פונט עברי מומלץ: Heebo / Assistant / Alef
